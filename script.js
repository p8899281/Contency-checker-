...
function renderStats(){
  ...
  const weekTaskProgress = taskProgressForRange(weekStart, now);
  const monthTaskProgress = taskProgressForRange(monthStart, now);
  const sixMonthTaskProgress = taskProgressForRange(sixMonthStart, now);
  ...
  if($("#dashWeeklyProgress")) $("#dashWeeklyProgress").textContent = `${Math.min(100, weekTaskProgress.percent)}%`;
  if($("#dashMonthlyProgress")) $("#dashMonthlyProgress").textContent = `${Math.min(100, monthTaskProgress.percent)}%`;
  if($("#dash6MonthProgress")) $("#dash6MonthProgress").textContent = `${Math.min(100, sixMonthTaskProgress.percent)}%`;
